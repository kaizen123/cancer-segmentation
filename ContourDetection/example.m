...
% cd ../../projects/academic/scottdoy/code/quant_risk_steve/Segmentation/BSR_code/BSR/grouping
% addpath(fullfile(pwd,'lib'));
addpath(genpath('/projects/academic/scottdoy/code/quant_risk_steve/Segmentation/BSR_code'))
%% 1. compute globalPb on a BSDS image (5Gb of RAM required)
clear all; close all; clc;

root_dir = '/projects/academic/scottdoy/code/quant_risk_steve/Segmentation';

imgFile = [root_dir filesep 'BSR_code/BSR/grouping/data/S15-6200-D2-01A_100_patch_1.tif'];
outFile = [root_dir filesep 'BSR_code/BSR/grouping/data/101087_gPb.mat'];
