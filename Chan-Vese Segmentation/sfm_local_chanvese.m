...
%function [seg Lz] = sfm_local_chanvese(img,mask,iterations,lam,rad,display)
  ...
  %input location and directory name of a patch to segment along with its associated annotation.
  root_dir = 'C:\Users\smschnei\Desktop\Size1\Patch 2';
  imfile = [root_dir filesep 'S15-6200-D2-01A_100_patch_2.tif'];
  maskfile = [root_dir filesep 'S15-6200-D2-01A_mask_100_patch_2.tif'];
  img = imread(imfile);
